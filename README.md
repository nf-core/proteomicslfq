...
The nf-core/proteomicslfq pipeline comes with documentation about the pipeline which you can read at [https://nf-core/proteomicslfq/docs](https://nf-core/proteomicslfq/docs) or find in the [`docs/` directory](docs).
